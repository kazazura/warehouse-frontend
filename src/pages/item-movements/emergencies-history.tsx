...
import { useGetIdentity, useInvalidate, useLink, useList, useNotification, useOne } from "@refinedev/core";
...
const EmergencyMovementHistoryPage = () => {
        ...
        <ListView>
            <div className="flex flex-col gap-4">
                ...
                <div className="flex justify-between gap-4">
                    <h2 className="text-2xl font-bold">Emergency History</h2>
                </div>
            </div>
            ...
            <div className="grid gap-6 min-w-0">
                <div className="intro-row">
                    <p className="text-muted-foreground">
                        Review rolled back emergency transactions and inspect affected item details.
                    </p>
                    <div className="actions-row">
                        ...
                        <Button type="button" variant="outline" onClick={() => navigate("/emergency")}>
                            Back to Emergency
                        </Button>
                    </div>
                </div>
...
export default EmergencyMovementHistoryPage;
